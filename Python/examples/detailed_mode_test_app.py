...
import sys, os, uuid, time, io
# sys.path.insert(0, '/Users/anthonycui/Documents/Coding/semantria-sdk/Python')
import semantria
...
# import io for compatibility with Python 2 cause fucking imports don't work with Python3
